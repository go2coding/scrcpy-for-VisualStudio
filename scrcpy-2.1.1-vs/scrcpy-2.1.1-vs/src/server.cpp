...
#define PREFIX ""
#define SC_SERVER_PATH_DEFAULT PREFIX "..\\Debug\\adb\\" SC_SERVER_FILENAME
...
sc_server_on_terminated(void *userdata) {
    struct sc_server* server = (struct sc_server*)userdata;
...
run_server(void *data) {
    struct sc_server *server = (struct sc_server*)data;
    ...
    need_initial_serial = !params->tcpip_dst;
...
#define WATCHDOG_DELAY SC_TICK_FROM_SEC(1)
        ...
        terminated = sc_process_observer_timedwait(&observer, deadline);
